...
class XmlPropertyMapper implements PropertyMapperInterface 
{
     ...
     * @param mixed $value
     */
    private function setValue(ObjectWrapper $object, Property $property, $value): void
    {
     ...
     * @return mixed
     */
    private function mapPropertyValue(MapperInterface $mapper, Property $property, $value)
    {
